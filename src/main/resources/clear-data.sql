...
-- Supprimer les données des tables avant de réinserer les données pour éviter des conflits
...
-- Réactiver les contraintes des clés étrangères après suppression des données.
